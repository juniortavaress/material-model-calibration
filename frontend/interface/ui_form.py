...
"")
        ...
        self.frame_4.setMaximumSize(QSize(465, 200))
...
"border: 1px solid rgb(113, 113, 113);}")
        ...
        self.verticalLayout_32.addWidget(self.frame_53)
...
"")
        ...
        self.frame_73.setMaximumSize(QSize(600, 16777215))
        ...
        self.horizontalLayout_10 = QHBoxLayout(self.frame_105)
        self.horizontalLayout_10.setSpacing(20)
        self.horizontalLayout_10.setObjectName(u"horizontalLayout_10")
        self.horizontalLayout_10.setContentsMargins(-1, 0, -1, -1)
        self.frame_plastic = QFrame(self.frame_105)
        self.frame_plastic.setObjectName(u"frame_plastic")
        self.frame_plastic.setEnabled(True)
        self.frame_plastic.setFrameShape(QFrame.Shape.StyledPanel)
        self.frame_plastic.setFrameShadow(QFrame.Shadow.Raised)
        self.verticalLayout_44 = QVBoxLayout(self.frame_plastic)
        self.verticalLayout_44.setSpacing(0)
        self.verticalLayout_44.setObjectName(u"verticalLayout_44")
        self.verticalLayout_44.setContentsMargins(0, 0, 0, 0)
        self.frame_76 = QFrame(self.frame_plastic)
        ...
        self.frame_limits_plastic = QFrame(self.frame_plastic)
        ...
        self.horizontalLayout_10.addWidget(self.frame_plastic)

        self.frame_damage = QFrame(self.frame_105)
        self.frame_damage.setObjectName(u"frame_damage")
        self.frame_damage.setEnabled(True)
        self.frame_damage.setFrameShape(QFrame.Shape.StyledPanel)
        self.frame_damage.setFrameShadow(QFrame.Shadow.Raised)
        self.verticalLayout_49 = QVBoxLayout(self.frame_damage)
        self.verticalLayout_49.setSpacing(0)
        self.verticalLayout_49.setObjectName(u"verticalLayout_49")
        self.verticalLayout_49.setContentsMargins(0, 0, 0, 0)
        self.frame_90 = QFrame(self.frame_damage)
        ...
        self.frame_limits_damage = QFrame(self.frame_damage)
        ...
        self.horizontalLayout_10.addWidget(self.frame_damage)
...
"#label_cores, #label_number_conditions, #lineEdit_number_iteration, #lineEdit_number_particles, #lineEdit_w, #lineEdit_fig, #lineEdit_fip {\n"
"color: rgb(0, 0, 0);\n"
"background-color: rgba(255, 255, 255, 150);\n"
"border-radius: 10px;\n"
"border: 1px solid rgb(113, 113, 113);}\n"
...
"")
        ...
        self.lineEdit_w = QLineEdit(self.frame_144)
        self.lineEdit_w.setObjectName(u"lineEdit_w")
        self.lineEdit_w.setMinimumSize(QSize(65, 20))
        self.lineEdit_w.setMaximumSize(QSize(65, 20))
        self.lineEdit_w.setAlignment(Qt.AlignmentFlag.AlignCenter)

        self.horizontalLayout_86.addWidget(self.lineEdit_w)
        ...
        self.lineEdit_fip = QLineEdit(self.frame_143)
        self.lineEdit_fip.setObjectName(u"lineEdit_fip")
        self.lineEdit_fip.setMinimumSize(QSize(65, 20))
        self.lineEdit_fip.setMaximumSize(QSize(65, 20))
        self.lineEdit_fip.setAlignment(Qt.AlignmentFlag.AlignCenter)

        self.horizontalLayout_85.addWidget(self.lineEdit_fip)
        ...
        self.lineEdit_fig = QLineEdit(self.frame_145)
        self.lineEdit_fig.setObjectName(u"lineEdit_fig")
        self.lineEdit_fig.setMinimumSize(QSize(65, 20))
        self.lineEdit_fig.setMaximumSize(QSize(65, 20))
        self.lineEdit_fig.setAlignment(Qt.AlignmentFlag.AlignCenter)

        self.horizontalLayout_87.addWidget(self.lineEdit_fig)
...
"")
        ...
        self.horizontalLayout_2 = QHBoxLayout(self.frame_129)
        ...
        self.frame_results_graph.setMinimumSize(QSize(250, 0))
        ...
        self.horizontalLayout_2.addWidget(self.frame_results_graph)

        self.frame_tracking = QFrame(self.frame_129)
        self.frame_tracking.setObjectName(u"frame_tracking")
        self.frame_tracking.setMinimumSize(QSize(0, 0))
        self.frame_tracking.setFrameShape(QFrame.Shape.StyledPanel)
        self.frame_tracking.setFrameShadow(QFrame.Shadow.Raised)
        self.verticalLayout_64 = QVBoxLayout(self.frame_tracking)
        self.verticalLayout_64.setSpacing(5)
        self.verticalLayout_64.setObjectName(u"verticalLayout_64")
        self.verticalLayout_64.setContentsMargins(5, 5, 5, 5)
        self.scrollArea = QScrollArea(self.frame_tracking)
        self.scrollArea.setObjectName(u"scrollArea")
        self.scrollArea.setWidgetResizable(True)
        self.scrollAreaWidgetContents = QWidget()
        self.scrollAreaWidgetContents.setObjectName(u"scrollAreaWidgetContents")
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 209, 844))
        self.verticalLayout_77 = QVBoxLayout(self.scrollAreaWidgetContents)
        ...
        self.verticalLayout_77.addWidget(self.label_code_status)

        self.scrollArea.setWidget(self.scrollAreaWidgetContents)

        self.verticalLayout_64.addWidget(self.scrollArea)


        self.horizontalLayout_2.addWidget(self.frame_tracking)
        ...
        self.frame_161.setMinimumSize(QSize(500, 0))
        ...
        self.frame_151 = QFrame(self.frame_161)
        ...
        self.frame_5 = QFrame(self.frame_151)
        ...
        self.verticalLayout_86 = QVBoxLayout(self.frame_164)
        self.verticalLayout_86.setSpacing(0)
        self.verticalLayout_86.setObjectName(u"verticalLayout_86")
        self.verticalLayout_86.setContentsMargins(1, 0, 0, 0)
        self.label_143 = QLabel(self.frame_164)
        self.label_143.setObjectName(u"label_143")
        font7 = QFont()
        font7.setFamilies([u"Yu Gothic UI Semilight"])
        font7.setPointSize(14)
        font7.setBold(True)
        self.label_143.setFont(font7)
        self.label_143.setFrameShape(QFrame.Shape.NoFrame)

        self.verticalLayout_86.addWidget(self.label_143)


        self.verticalLayout_84.addWidget(self.frame_164)

        self.frame_165 = QFrame(self.frame_162)
        ...
        self.verticalLayout_89 = QVBoxLayout(self.frame_165)
        self.verticalLayout_89.setObjectName(u"verticalLayout_89")
        self.combobox_tracking_graph = QComboBox(self.frame_165)
        self.combobox_tracking_graph.addItem("")
        self.combobox_tracking_graph.addItem("")
        self.combobox_tracking_graph.setObjectName(u"combobox_tracking_graph")
        self.combobox_tracking_graph.setEnabled(True)
        self.combobox_tracking_graph.setMinimumSize(QSize(0, 20))
        self.combobox_tracking_graph.setMaximumSize(QSize(16777215, 20))
        self.combobox_tracking_graph.setStyleSheet(u"")

        self.verticalLayout_89.addWidget(self.combobox_tracking_graph)


        self.verticalLayout_84.addWidget(self.frame_165)


        self.verticalLayout_4.addWidget(self.frame_162)


        self.verticalLayout_82.addWidget(self.frame_5)


        self.verticalLayout_74.addWidget(self.frame_151)

        self.frame_graph_analysis = QFrame(self.frame_161)
        self.frame_graph_analysis.setObjectName(u"frame_graph_analysis")
        self.frame_graph_analysis.setStyleSheet(u"")
        self.frame_graph_analysis.setFrameShape(QFrame.Shape.StyledPanel)
        self.frame_graph_analysis.setFrameShadow(QFrame.Shadow.Raised)
        self.verticalLayout_73 = QVBoxLayout(self.frame_graph_analysis)
        self.verticalLayout_73.setSpacing(15)
        self.verticalLayout_73.setObjectName(u"verticalLayout_73")
        self.verticalLayout_73.setContentsMargins(0, 0, 0, 0)
        self.frame_150 = QFrame(self.frame_graph_analysis)
        ...
        self.label_142 = QLabel(self.frame_152)
        self.label_142.setObjectName(u"label_142")
        self.label_142.setFont(font7)
        self.label_142.setFrameShape(QFrame.Shape.NoFrame)

        self.verticalLayout_83.addWidget(self.label_142)
        ...
        self.frame_forces_and_chip = QFrame(self.frame_graph_analysis)
        self.frame_forces_and_chip.setObjectName(u"frame_forces_and_chip")
        self.frame_forces_and_chip.setFrameShape(QFrame.Shape.StyledPanel)
        self.frame_forces_and_chip.setFrameShadow(QFrame.Shadow.Raised)
        self.verticalLayout_61 = QVBoxLayout(self.frame_forces_and_chip)
        self.verticalLayout_61.setSpacing(15)
        self.verticalLayout_61.setObjectName(u"verticalLayout_61")
        self.verticalLayout_61.setContentsMargins(0, 0, 0, 0)
        self.frame_171 = QFrame(self.frame_forces_and_chip)
        self.frame_171.setObjectName(u"frame_171")
        self.frame_171.setMinimumSize(QSize(0, 80))
        self.frame_171.setFrameShape(QFrame.Shape.StyledPanel)
        self.frame_171.setFrameShadow(QFrame.Shadow.Raised)
        self.verticalLayout_95 = QVBoxLayout(self.frame_171)
        self.verticalLayout_95.setSpacing(0)
        self.verticalLayout_95.setObjectName(u"verticalLayout_95")
        self.verticalLayout_95.setContentsMargins(0, 0, 0, 0)
        self.frame_176 = QFrame(self.frame_171)
        ...
        self.verticalLayout_96 = QVBoxLayout(self.frame_176)
        self.verticalLayout_96.setSpacing(0)
        self.verticalLayout_96.setObjectName(u"verticalLayout_96")
        self.verticalLayout_96.setContentsMargins(1, 0, 0, 0)
        self.label_145 = QLabel(self.frame_176)
        ...
        self.verticalLayout_95.addWidget(self.frame_176)

        self.frame_177 = QFrame(self.frame_171)
        ...
        self.verticalLayout_97 = QVBoxLayout(self.frame_177)
        self.verticalLayout_97.setObjectName(u"verticalLayout_97")
        self.combobox_iteration = QComboBox(self.frame_177)
        self.combobox_iteration.addItem("")
        self.combobox_iteration.setObjectName(u"combobox_iteration")
        self.combobox_iteration.setEnabled(True)
        self.combobox_iteration.setMinimumSize(QSize(0, 20))
        self.combobox_iteration.setMaximumSize(QSize(16777215, 20))
        self.combobox_iteration.setStyleSheet(u"")

        self.verticalLayout_97.addWidget(self.combobox_iteration)


        self.verticalLayout_95.addWidget(self.frame_177)


        self.verticalLayout_61.addWidget(self.frame_171)

        self.frame_148 = QFrame(self.frame_forces_and_chip)
        ...
        self.verticalLayout_61.addWidget(self.frame_148)

        self.verticalSpacer_12 = QSpacerItem(20, 15, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Fixed)

        self.verticalLayout_61.addItem(self.verticalSpacer_12)

        self.frame_156 = QFrame(self.frame_forces_and_chip)
        ...
        self.verticalLayout_61.addWidget(self.frame_156)


        self.verticalLayout_73.addWidget(self.frame_forces_and_chip)


        self.verticalLayout_74.addWidget(self.frame_graph_analysis)
        ...
        self.button_result_back.setMinimumSize(QSize(100, 0))
        self.button_result_back.setMaximumSize(QSize(100, 40))
        self.button_result_back.setStyleSheet(u"")

        self.horizontalLayout_94.addWidget(self.button_result_back)

        self.pushButton_extract_graph = QPushButton(self.frame_130)
        self.pushButton_extract_graph.setObjectName(u"pushButton_extract_graph")
        self.pushButton_extract_graph.setMinimumSize(QSize(100, 40))
        self.pushButton_extract_graph.setMaximumSize(QSize(100, 16777215))

        self.horizontalLayout_94.addWidget(self.pushButton_extract_graph)

        self.pushButton_extract_data = QPushButton(self.frame_130)
        self.pushButton_extract_data.setObjectName(u"pushButton_extract_data")
        self.pushButton_extract_data.setMinimumSize(QSize(100, 0))
        self.pushButton_extract_data.setMaximumSize(QSize(100, 40))

        self.horizontalLayout_94.addWidget(self.pushButton_extract_data)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_34.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p><span style=\" font-weight:700;\">Error:</span><br/><span style=\" color:#ffffff;\">..........</span>( (w<span style=\" vertical-align:sub;\">fc</span> \u00b7 \u03b5<span style=\" vertical-align:sub;\">fc</span><span style=\" vertical-align:super;\">2</span>) + (w<span style=\" vertical-align:sub;\">fn</span> \u00b7 \u03b5<span style=\" vertical-align:sub;\">fn</span><span style=\" vertical-align:super;\">2</span>) + (w<span style=\" vertical-align:sub;\">ccr</span> \u00b7 \u03b5<span style=\" vertical-align:sub;\">ccr</span><span style=\" vertical-align:super;\">2</span>) + (w<span style=\" vertical-align:sub;\">csr</span> \u00b7 \u03b5<span style=\" vertical-align:sub;\">csr</span><span style=\" vertical-align:super;\">2</span>) )<span style=\" vertical-align:super;\">0.5</span></p></body></html>", None))
        ...
        self.label_45.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p><span style=\" font-size:14pt; font-weight:700;\">Particle Swarm Optimization (PSO):</span></p><p align=\"justify\"><span style=\" font-size:11pt; color:#f5f5f5;\">. . </span><span style=\" font-size:11pt;\">It's an optimization algorithm inspired by the collective behavior of organisms like birds or fish. It uses a population of particles, each representing a potential solution. Each particle updates its position based on its personal best solution and the global best. PSO is effective for material model calibration, as it explores large parameter spaces to find solutions that minimize the difference between experimental and simulated data.</span></p><p align=\"justify\"><span style=\" font-size:11pt;\"><br/></span><span style=\" font-size:11pt; font-weight:700;\">\u03c9 (inertia)</span><span style=\" font-size:11pt;\">: Controls the tendency of particles to maintain their previous velocities, balancing global and local exploration.<br/></span></p><p align=\"justify\"><img src=\"data:ima"
                        "ge/png;base64,\" width=\"18\" height=\"24\"/><span style=\" font-size:11pt;\"/><span style=\" font-size:11pt; font-weight:700;\"> (cognitive coefficient)</span><span style=\" font-size:11pt;\">: Determines the attraction of a particle to its own best-found solution, encouraging local exploration.</span></p><p align=\"justify\"><span style=\" font-size:11pt;\"><br/></span><img src=\"data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABMAAAAYCAMAAAAvSTY9AAAAAXNSR0IArs4c6QAAAGxQTFRFAAAAAA"
                        "\" width=\"19\" height=\"24\"/><span style=\" font-size:11pt; font-weight:700;\"> (social coefficient)</span><span style=\" font-size:11pt;\">: Controls the attraction to the global best solution, promoting collaboration between particles and global exploration.</span></p></body></html>", None))
        ...
        self.label_133.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>\u03c9</p></body></html>", None))
        self.lineEdit_w.setText(QCoreApplication.translate("MainWindow", u"0.5", None))
        self.lineEdit_w.setPlaceholderText(QCoreApplication.translate("MainWindow", u"0.5", None))
        self.label_132.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p><img src=\"data:image/png;base64,\" width=\"18\" height=\"24\"/></p></body></html>", None))
        self.lineEdit_fip.setText(QCoreApplication.translate("MainWindow", u"1.3", None))
        self.lineEdit_fip.setPlaceholderText(QCoreApplication.translate("MainWindow", u"2.0", None))
        self.label_134.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p><img src=\"data:image/png;base64,\" width=\"19\" height=\"24\"/></p></body></html>", None))
        self.lineEdit_fig.setText(QCoreApplication.translate("MainWindow", u"1.7", None))
        self.lineEdit_fig.setPlaceholderText(QCoreApplication.translate("MainWindow", u"2.0", None))
        ...
        self.label_143.setText(QCoreApplication.translate("MainWindow", u"Results", None))
        self.combobox_tracking_graph.setItemText(0, QCoreApplication.translate("MainWindow", u"Code Tracking", None))
        self.combobox_tracking_graph.setItemText(1, QCoreApplication.translate("MainWindow", u"Graphs", None))
        ...
        self.label_145.setText(QCoreApplication.translate("MainWindow", u"Iteration:", None))
        self.combobox_iteration.setItemText(0, QCoreApplication.translate("MainWindow", u"None", None))
        ...
        self.pushButton_extract_graph.setText(QCoreApplication.translate("MainWindow", u"Extract Graph", None))
        self.pushButton_extract_data.setText(QCoreApplication.translate("MainWindow", u"Extract Datas", None))
