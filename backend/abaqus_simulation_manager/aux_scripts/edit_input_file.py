...
class InpEditor():
    def manager_edit(self) -> Tuple[List[str], Dict[int, str]]:
        """
        Main function to edit .inp files based on parameters defined in a YAML file.

        Returns:
            Tuple[List[str], Dict[int, str]]:
                - A list of directories where the modified .inp files are saved.
                - A dictionary mapping global index to the name of each generated .inp file (without extension).
        """
        # Creating variables
        lis_dir_inp = []
        index_names = {}
