...
class GetTemps:
    ...
    def __init__(self):
        ...
        """
        # self.project_name = "Teste"
        # self.json_dir = "S:/Junior/abaqus-with-python/otimization-scripts/new-version/material-model-calibration\Teste\auxiliary_files\json_and_obj_files/jsonFiles"
        # self.odb_dir = "S:/Junior/abaqus-with-python/otimization-scripts/new-version/material-model-calibration\Teste\auxiliary_files\odb_processing"
        ...
        node_range_strs, spanwinkel_nodes = GetTemps.initialize_data()
    ...
    def initialize_data():
        ...
        """
        # software_path = os.path.join(os.getenv("SystemDrive", "C:") , "\MaterialOtimization", project_name)
